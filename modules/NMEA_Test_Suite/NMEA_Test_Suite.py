...
class testSuite:
	...
	*******************************************************************************/
	...
	testStringsGarminG12 = list()
	testStringsGarminG12.append("$GPRMC,183729, A,3907.356, N,12102.482, W,000.0,360.0,080301,015.5, E*6F")
	testStringsGarminG12.append("$GPRMB, A,,,,,,,,,,,, V*71")
	testStringsGarminG12.append("$GPGGA,183730,3907.356, N,12102.482, W,1,05,1.6,646.4, M,-24.1, M,,*75",)
	testStringsGarminG12.append("$GPGSA, A,3,02,,,07,,09,24,26,,,,,1.6,1.6,1.0*3D")
	testStringsGarminG12.append("$GPGSV,2,1,08,02,43,088,38,04,42,145,00,05,11,291,00,07,60,043,35*71")
	testStringsGarminG12.append("$GPGSV,2,2,08,08,02,145,00,09,46,303,47,24,16,178,32,26,18,231,43*77")
	testStringsGarminG12.append("$PGRME,22.0, M,52.9, M,51.0, M*14")
	testStringsGarminG12.append("$GPGLL,3907.360, N,12102.481, W,183730, A*33")
	testStringsGarminG12.append("$PGRMZ,2062, f,3*2D")
	testStringsGarminG12.append("$PGRMM, WGS 84*06")
	testStringsGarminG12.append("$GPBOD,, T,, M,,*47")
	testStringsGarminG12.append("$GPRTE,1,1, c,0*07")
	testStringsGarminG12.append("$GPRMC,183731, A,3907.482, N,12102.436, W,000.0,360.0,080301,015.5, E*67")
	testStringsGarminG12.append("$GPRMB, A,,,,,,,,,,,, V*71")
	
	# Add the Garmin G12 sentences to the main dictionary
	dictTestSentences.append("GarminG12", testStringsGarminG12)
	...
	***************************************************************************/
	'''	
	testStringsGarminEtrexSummit = list()
	testStringsGarminEtrexSummit.append("$GPRMC,002454, A,3553.5295, N,13938.6570, E,0.0,43.1,180700,7.1, W, A*3F")
	testStringsGarminEtrexSummit.append("$GPRMB, A,,,,,,,,,,,, A, A*0B")
	testStringsGarminEtrexSummit.append("$GPGGA,002454,3553.5295, N,13938.6570, E,1,05,2.2,18.3, M,39.0, M,,*7F")
	testStringsGarminEtrexSummit.append("$GPGSA, A,3,01,04,07,16,20,,,,,,,,3.6,2.2,2.7*35")
	testStringsGarminEtrexSummit.append("$GPGSV,3,1,09,01,38,103,37,02,23,215,00,04,38,297,37,05,00,328,00*70") 
	testStringsGarminEtrexSummit.append("$GPGSV,3,2,09,07,77,299,47,11,07,087,00,16,74,041,47,20,38,044,43*73")
	testStringsGarminEtrexSummit.append("$GPGSV,3,3,09,24,12,282,00*4D")
	testStringsGarminEtrexSummit.append("$GPGLL,3553.5295, N,13938.6570, E,002454, A, A*4F",)
	testStringsGarminEtrexSummit.append("$GPBOD,, T,, M,,*47")
	testStringsGarminEtrexSummit.append("$GPRTE,1,1, c,*37")
	testStringsGarminEtrexSummit.append("$GPRMC,002456, A,3553.5295, N,13938.6570, E,0.0,43.1,180700,7.1, W, A*3D")

	# Add the Garmin Etrex Summit sentences to the main dictionary
	dictTestSentences.append("GarminEtrexSummit", testStringsGarminEtrexSummit)
	...
	**********************************************************************************/
	'''
	testStringsGarminEtrexVista = list(
	...
	# Add the Garmin Etrex Vista sentences to the main dictionary
	dictTestSentences.append("GarminEtrexVista", testStringsGarminEtrexVista)
	...
	******************************************************************************/
	'''
	testStringsGarminBasicYellowEtrex = list(
	...
	# Add the Garmin Basic Yellow Etrex sentences to the main dictionary
	dictTestSentences.append("GarminBasicYellowEtrex", testStringsGarminBasicYellowEtrex)
	...
	****************************************************************************/
	'''
	testStringsMagellanGPScompanion = list(
	...
	# Add the Magellan GPS Companion sentences to the main dictionary
	dictTestSentences.append("MagellanGPScompanion", testStringsMagellanGPScompanion)
	...
	****************************************************************************/
	...
	# Add the Magellan 315 sentences to the main dictionary
	dictTestSentences.append("Magellan315", testStringsMagellan315)
	...
	***************************************************************************/
	...
	# Add the Raytheon RN300 sentences to the main dictionary
	dictTestSentences.append("RaytheonRN300", testStringRaytheonRN300)
	...
	*************************************************/
	...
	# Add the NavMan 3400 sentences to the main dictionary
	dictTestSentences.append("NavMan3400", testStringNavMan3400)
	...
	***************************************************************************/
	'''
	testStringEarhtmateSiRFChipset = list(
	...
	# Add the EarhtmateSiRFChipset sentences to the main dictionary
	dictTestSentences.append("EarhtmateSiRFChipset", testStringEarhtmateSiRFChipset)
	...
	***************************************************************************/
	...
	testStringEvermoreGM305 = list(
 	...
 	# Add the Evermore GM305 sentences to the main dictionary
	dictTestSentences.append("EvermoreGM305", testStringEvermoreGM305)
	...
	***************************************************************************/
	...
	# Add the testStringSony sentences to the main dictionary
	dictTestSentences.append("testStringSony", testStringSony)
	...
	****************************************************************************/
	...
	# Add the UBlox sentences to the main dictionary
	dictTestSentences.append("UBlox", testStringUBlox)
